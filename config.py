...
def vocab_opts(parser):
    ...
    parser.add_argument('-bow_data_soure', default='post',
                        choices=['post', 'conv'], help='source data for ntm')
    parser.add_argument('-decoder_choice', action='store_true', help='answer')
    ...
    parser.add_argument('-max_trg_len', type=int, default=15,
